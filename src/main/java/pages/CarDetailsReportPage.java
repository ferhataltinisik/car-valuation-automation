...
public class CarDetailsReportPage {
    ...
    public VehicleDetails getCarDetails() {
        ...
        String year = getTableCellValue(carDetailsTable, "Year of manufacture");
        return new VehicleDetails(make, model, year, "");  // Value/Price can be empty if not shown
    }
    ...
    private String getTableCellValue(WebElement table, String label) {
        ...
        throw new NoSuchElementException("No table row found for label: " + label);
    }
